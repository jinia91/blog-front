...
export default async function ArticlePage ({ params }: { params: { id: string } }): Promise<React.ReactElement> {
  ...
  return (
    <div
      className="relative p-4 text-gray-300 bg-gray-900 border-2 border-green-400 h-[calc(100vh-180px)] overflow-y-auto scrollbar-thumb-green-400 scrollbar-track-gray-700 flex justify-center">
      <div
