  ...
  return (
    <main className="flex flex-col min-h-screen bg-gray-900 text-gray-300 border-2 border-green-400">
      ...
      <LatestSection title="최신글" posts={[
        { id: 1, title: '포스트 1', thumbnail: 'https://via.placeholder.com/150' },
        { id: 2, title: '포스트 2', thumbnail: 'https://via.placeholder.com/150' },
        { id: 3, title: '포스트 3', thumbnail: 'https://via.placeholder.com/150' },
        { id: 4, title: '포스트 4', thumbnail: 'https://via.placeholder.com/150' }
      ]}/>
    </main>
  )
}
